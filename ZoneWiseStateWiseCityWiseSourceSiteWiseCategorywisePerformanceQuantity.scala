...
object ZoneWiseStateWiseCityWiseSourceSiteWiseCategorywisePerformanceQuantity {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.ZoneWiseStateWiseCityWiseSourceSiteWiseCategorywisePerformanceQuantity")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.ZoneWiseStateWiseCityWiseSourceSiteWiseCategorywisePerformanceQuantity")
    ...
    results.foreach({ rdd =>
      ...
      val newDocs = Seq(new Document("TimeStamp",today).append("Category",rdd._1).append("SourceSite",rdd._2).append("City",rdd._3).append("State",rdd._4).append("Zone",rdd._5).append("Quantity",rdd._6))
