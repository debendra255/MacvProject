...
object ZoneWiseStateWiseCityWiseSourceSiteWiseCustomerDetailsFilled {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.ZoneWiseStateWiseCityWiseSourceSiteWiseCustomerDetailsFilled")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.ZoneWiseStateWiseCityWiseSourceSiteWiseCustomerDetailsFilled")
   ...
   val results = finalResult.collect()
    ...
    results.foreach({ rdd =>
      ...
      val newDocs = Seq(new Document("TimeStamp",today).append("Zone",rdd._4).append("State",rdd._3).append("City",rdd._2).append("SourceSite",rdd._1).append("CustomerMobile",rdd._5).append("Count",rdd._6))
